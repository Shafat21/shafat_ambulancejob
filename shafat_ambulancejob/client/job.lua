...
function OpenMobileAmbulanceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mobile_ambulance_actions', {
		...
		elements = {
			...
			{label = '<span style="color:green;">🚑EMS Available<span style="color:white;">', value = 'ems_ouvert'},
			{label = '<span style="color:red;">🚒EMS not Available<span style="color:white;">', value = 'ems_ferme'}
		}
	}, function(data, menu)
		...
		elseif data.current.value == 'citizen_interaction' then
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				...
				elements = {
					...
					{label = "💞Invoice - Small Amount", value = 'fine_menu'},
					{label = "💕Invoice - Big Amount", value = 'fine_menubig'}
				}
			}, function(data, menu)
