Locales['en'] = {
  ...
  ['ems_menu_small'] = '❤️Heal small wounds',
  ...
  ['distress_send'] = 'Press [~b~G~s~] to  send 👨🏻‍⚕️Distress signal👨🏻‍⚕️',
  ...
  -- Extra
  ['billed'] = 'You have ~r~billed~s~ ~y~%s~s~ ~r~$600~s~',
  ['billedminor'] = 'You have ~r~billed~s~ ~y~%s~s~ ~r~$250~s~'
}
