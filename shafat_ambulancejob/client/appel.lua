...
AddEventHandler("emsAppelPris", function(Xid, XAppelCoords)
	ESX.ShowAdvancedNotification("EMS", "~b~EMS request", "You took the call, Follow the GPS route. FAST", "CHAR_CALL911", 8)   
	...
	-- Ajout de la route
     ...
     while rea do
          if GetDistanceBetweenCoords(XAcoords, GetEntityCoords(GetPlayerPed(-1))) < 10.0 then
               DrawMarker(20, XAcoords, 0, 0, 0, 0, 0, 0, 0.5, 0.5, 0.5, 66, 245, 87, 255, false, false, 2, true, false, false, false)
               Draw3DText(XAcoords.x, XAcoords.y, XAcoords.z, "~g~A person in need of revive here ...\nPress ~b~[E]~w~To revive.", 4, 0.1, 0.1)
